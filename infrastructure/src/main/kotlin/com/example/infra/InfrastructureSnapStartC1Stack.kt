...
class InfrastructureSnapStartC1Stack(scope: Construct, id: String, props: StackProps) : Stack(scope, id, props) {
    init {
        val productsTable = Table.fromTableArn(this, "dynamoTable", Fn.importValue("Products-Spring-Cloud-Function-ExampleTableArn"))
        val functionId = "lambdaSpringCloudFunctionSnapStartC1"
        val function = Function.Builder.create(this, functionId)
            .description("Kotlin Lambda Spring Cloud Function JVM X86 SnapStart C1")
